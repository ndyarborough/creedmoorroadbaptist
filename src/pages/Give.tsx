    ...
    return (
        <PageLayout pageId="give">
            <Flex direction="col" gap={8} className="py-8 lg:py-12 max-w-[90%] lg:max-w-[60%] mx-auto">
                ...
                <Text variant="body">Your generous contributions make it possible for Creedmoor Road Baptist Church to continue its mission of spreading God's love, supporting our community, and growing disciples. We believe that giving is an act of worship and an expression of gratitude for God's blessings in our lives.</Text>
